...
class DamonCreazioni extends React.Component {
    ...
    render() {
        return (
            <Layout>
                <Head>
                    <title>Damon Creazioni</title>
                    <meta name="description" content="" />
                </Head>
                <div>
                    <BannerDynamic title="Damon Creazioni" imageUrl="screenshot-damon-creazioni.jpg" />
                    <div id="main">
                        <section id="one">
                            <div className="inner">
